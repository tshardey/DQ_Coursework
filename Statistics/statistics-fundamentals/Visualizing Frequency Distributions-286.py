...
wnba['Exp_ordinal'].value_counts()[['Rookie','Little experience','Experienced','Very experienced','Veteran']].plot.bar()

## 3. Horizontal Bar Plots ##

wnba['Exp_ordinal'].value_counts()[['Rookie','Little experience','Experienced','Very experienced','Veteran']].plot.barh(title = "Number of players in WNBA by level of experience")
