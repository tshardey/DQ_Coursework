...
train_predict = clf.predict(train[columns])
test_predict = clf.predict(test[columns])


clf2 = DecisionTreeClassifier(random_state=1, max_depth=5)
clf2.fit(train[columns], train["high_income"])
train_predict2 = clf2.predict(train[columns])
test_predict2 = clf2.predict(test[columns])

print(roc_auc_score(test['high_income'], test_predict), roc_auc_score(test['high_income'], test_predict2))
...
mean_predict = numpy.round((predictions+predictions2)/2)

print(roc_auc_score(test['high_income'], mean_predict))
...
mean_pred = numpy.round(sum(predictions)/10)
print(roc_auc_score(test['high_income'], mean_pred))
