...
def assign_to_cluster(row):
    distance_dict = {}
    for centroid, value in centroids_dict.items():
        distance_dict[centroid] = calculate_distance(value, [row['ppg'], row['atr']])
...
def recalculate_centroids(df):
    ...
    for cluster_id in range(0, num_clusters):
        ...
        new_centroids_dict[cluster_id] = [cluster['ppg'].mean(), cluster['atr'].mean()]
